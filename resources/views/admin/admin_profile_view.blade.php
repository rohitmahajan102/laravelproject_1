        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card"><br><br>
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Name : {{ $adminDetails->name }} </h4>
                        <hr>
                        <h4 class="card-title">User Email : {{ $adminDetails->email }} </h4>
                        <hr>
                        <h4 class="card-title">User Name : {{ $adminDetails->username }} </h4>
                        <hr>
